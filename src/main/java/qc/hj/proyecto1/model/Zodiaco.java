...
"	Hoy no te sientas excesivamente aprensiva o innecesariamente nerviosa."));
        ...
        signo.add(new Signos("Geminis", "Cuando miramos la superficie de un lago ¿cómo sabemos qué hay debajo? Y si el viento está soplando y se forman ondas en el agua, \n" +
...
"	Hoy intenta darle el beneficio de la duda."));
        ...
        signo.add(new Signos("Cancer", "A todos nos gusta pensar que si alguna vez nos encontramos con un problema, seremos capaces de ponerlo en las manos de un experto.\n" +
